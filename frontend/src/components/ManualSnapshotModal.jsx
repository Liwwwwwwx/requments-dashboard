...
function getDefaultUnit(account) {
...
export function ManualSnapshotModal({ open, accounts, saving, onCancel, onSubmit }) {
  ...
  const handleAccountChange = (nextId) => {
    setAccountId(nextId);
